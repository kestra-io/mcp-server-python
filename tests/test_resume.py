...
@pytest.mark.asyncio
async def test_resume_flow_with_pause_task(kestra_client, cleanup):
    """Test resume functionality with pause demo flow."""
    flow_response_json = await create_flow("pause_demo.yaml", kestra_client, cleanup)
    ...
    resume_result = await kestra_client.call_tool(
...
@pytest.mark.asyncio
async def test_resume_flow_with_on_resume_inputs(kestra_client, cleanup):
    """Test resume functionality with approval flow."""
    flow_response_json = await create_flow("approval.yaml", kestra_client, cleanup)
...
@pytest.mark.asyncio
async def test_resume_missing_params(kestra_client):
